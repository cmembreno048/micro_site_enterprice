        ...
        <div class="inside">
            ...
            <div class="row fila">
                ...
                <div class="col-lg-4 col-md-4 col-sm-4 col-12 my-3 column1">
                    ...
                    <a class="btn btn-primary w-100 my-5" href="{{url('/enterprice')}}"><i class="fas fa-plus"></i> Agregar nueva empresa</a>

                    <form action="{{url('/enterprice/edit/'.$enterprice->id)}}" method="post" enctype="multipart/form-data">

                        @csrf

                        <div class="form-group">
                            <label for="name">Nombre de la empresa</label>
                            <input type="text" name="name" class="form-control" value="{{$enterprice->name}}" id="name" autocomplete="off" required>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="email" name="email" value="{{$enterprice->email}}" class="form-control" id="email" autocomplete="off" >
                        </div>
                        @if ($errors->has('email'))
                            <div class="alert alert-danger mtop16">    
                        ...
                        <div class="form-group">
                            ...
                            <input type="text"name="web_site" value="{{$enterprice->web_site}}" class="form-control" id="web_site" autocomplete="off" >
                        </div>
                        ...
                        <div class="preview_image centerimg">
                            @if ($enterprice->image != null)
                                <img src="{{Storage::url($enterprice->image)}}" class="centerimg" alt="">
                            @else
                                <small>La empresa no tiene logotipo</small>
                            @endif
                        </div>
                        @if ($errors->has('image'))
                            <div class="alert alert-danger mtop16">    
