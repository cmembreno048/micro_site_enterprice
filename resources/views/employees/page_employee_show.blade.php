                ...
                <div class="col-lg-4 col-md-4 col-sm-4 col-12 my-3 column1">
                    ...
                    <form action="{{url('/employees')}}" method="post" enctype="multipart/form-data">
                        ...
                        <select name="enterprice_id" class="custom-select my-3">
                            <option value="null" selected>Empresa a la que pertenece</option>
                            @foreach ($enterprices as $enterprice)
                                
                                <option value="{{$enterprice->id}}">{{$enterprice->name}}</option>
                        ...
                        <button class="w-100 btn btn-primary px-2 my-3" type="submit"> Agregar Colaborador</button>
                    </form>
                </div>
